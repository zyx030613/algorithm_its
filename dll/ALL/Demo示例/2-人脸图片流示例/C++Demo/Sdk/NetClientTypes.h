...
#define  EXCEPTION_TYPE_MAX						(EXCEPTION_TYPE_MIN + 20)
...
#define ITS_EXTRAINFO_CMD_MAX									(ITS_EXTRAINFO_COMMON_CMD_MIN + 38)
...
#define NET_CLIENT_MAX								(NET_CLIENT_MIN + 198)
...
typedef  struct WaterSamplePoint
{
	...
	int	iGaugeType;		//  Gauge type，0-Reserved，1-Wide gauge、New gauge，2-Narrow gauge、Old gauge
	int iPresetCount;
