...
namespace NVSSDK_INTERFACE
{
	...
	pfNetClient_ProxyBindinterface	NetClient_ProxyBindinterface	=	NULL;
    ...
    int LoadNVSSDK(const char* _pszPath)
	{
		...
		NetClient_ProxyBindInterface     =    (pfNetClient_ProxyBindInterface)GetProcAddress(hNVSSDK, "NetClient_ProxyBindInterface");
